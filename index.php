...
<html>
	...
	<body>
		...
		<div id="header-image" data-role="header" data-theme="<?php echo $theme ?>">
		    <h1><a href="#page1" data-transition="turn"><img src="img/logo.png" alt="LOGO"></a></h1>
		</div>
		<div data-role="footer" data-theme="<?php echo $theme ?>">
			<h1>Powered by <a href="http://mobilegrows.com/">MobileGrows</a> | <a href="http://www.angilospizza.com/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
			    ...
			    <!-- Jssor Slider End -->
				<fieldset class="ui-grid-b" data-theme="<?php echo $theme ?>" style="text-align: center;">
					...
					<div class="ui-block-c"><a href="#contactform" data-transition="<?php echo $transitionefect ?>" data-direction="reverse"><img src="img/circle-btn1w.png" alt=""></a></div>   
				</fieldset>

              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-carat-r ui-btn-icon-right " href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Home Page</a>
                  </div>
              </div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-carat-r ui-btn-icon-right " href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">About Angilos</a>
					</div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-carat-r ui-btn-icon-right " href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Coupons</a>
					</div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-carat-r ui-btn-icon-right " href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">More Info</a>
					</div>
				</div>	
			...
			<div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Home Page</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">About Angilos</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Coupons</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">More Info</a></li>
											
							<li><a href="#contactform" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Contact Us</a></li>
						</ul>
					</section>
